  ...
  const renderProfileButton = () => {
    ...
    let menuItems = [
      <MenuItem
        key={0}
        disabled
        data-test-id="user-menu-username">
  ...
  return (
    <>
      <Head>
        ...
        <meta
          property="og:image"
          content="https://justthetalk.co.uk/justthetalk_new.png"
        />
      </Head>
      <AppBar
        ...
        className={[
          styles.appBar,
          hasLeftDrawer ? (leftDrawerState ? styles.leftDrawerOpen : styles.leftDrawerClosed) : styles.noLeftDrawer
        ].join(' ')}>
        <Toolbar className={styles.toolbar}>
          <div className={styles.logo}>
            <Link
              ...
              <a>
                <img
                  src="/justthetalk_new.png"
                  alt="Just The Talk Logo"
                />
              </a>
            </Link>
          </div>
          ...
          <div className={styles.strapline}>
            {!isNarrowWindow
              ? "Discuss the issues of the day in depth; from what you're watching, to football, science and philosophy via everything in-between."
              : ''}
          </div>
