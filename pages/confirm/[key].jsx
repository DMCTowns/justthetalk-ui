...
export default function ConfirmSignup() {
  ...
  return (
    <WidePageLayout title="JUSTtheTalk - Account Confirmation">
          ...
          {loadingState === LoadingState.Loaded ? (
            <Paper
              ...
              <Typography
                ...
                color="textSecondary"
                gutterBottom>
                Congratulations, you have successfully confirmed your account details. Click the button below to start
                posting...
              </Typography>
