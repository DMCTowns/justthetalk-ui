...
export default function Signup() {
  ...
  const onSubmit = token => {
    ...
    if (tokenValue.length === 0 && publicRuntimeConfig.environment == 'PRODUCTION') {
      ...
      <WidePageLayout title="JUSTtheTalk - Sign up">
        <div className={styles.content}>
          <div className={styles.loginFormContainer}>
            <div>
              <p>
                Welcome to JUSTtheTalk, the home of the Guardian Talk community. We are a community of individuals who
                enjoy discussing anything and everything. There are no limits to what can be talked about here but we
            ...
            <Paper
              ...
              <form
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        color="primary"
                        checked={agreeTerms}
                        onChange={onChangeAgreeTerms}></Checkbox>
                    }
                  />
                </div>
                {/* <div className={styles.recaptchaControl}><GoogleReCaptcha onVerify={onChangeCaptcha} /></div> */}
                ...
                {agreeTermsError && agreeTermsError.length > 0 ? (
                  <Alert
                    severity="error"
                    className={styles.userAlert}>
                    {agreeTermsError}
            ...
            <div>
              ...
              <p>
                On May 25th 2018 the EU's General Data Protection Regulation (GDPR) comes into force. This new
                legislation gives you more control and greater protections around how your personal data can be stored
                and used. For more information about how this relates to your use of JUSTtheTalk please refere to our{' '}
                <Link href="/privacy">
                  <a>privacy policy</a>
                </Link>
                .
