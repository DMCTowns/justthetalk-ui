...
export default function ResetPassword() {
  ...
  const onSubmit = token => {
    ...
    if (valid) {
      dispatch(updateUserPasswordFromKey({ resetKey: key, newPassword: password, recaptchaResponse: tokenValue }))
    }
  }
  ...
  return (
    <WidePageLayout title="JUSTtheTalk - Reset Password">
