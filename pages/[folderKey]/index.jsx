...
export default function FolderView(props) {
        ...
        {discussions.map((d, ix) => {
          return (
            <DiscussionIndexEntry
              key={ix}
              discussion={d}></DiscussionIndexEntry>
          )
        })}
      ...
      <div className="leftButtonMenu">
        <div className="leftButtonMenuInner">
          ...
          {currentFolder.isSubscribed ? (
            <ActionButton
              onClick={onSubscribeToFolder}
              icon={<NotificationsOffIcon />}
              label="Unsubscribe"
              testId="unsubscribe-folder"
            />
          ) : (
            <ActionButton
              onClick={onSubscribeToFolder}
  ...
  return (
    <MasterLayout
      title={`JUSTtheTalk - ${currentFolder ? currentFolder.description : 'Folder'}`}
      leftContent={renderLeftMenu()}>
      <Head>
        {currentFolder.key === 'admin' ||
        currentFolder.key === 'personal' ||
        currentFolder.key === 'mod' ||
        currentFolder.key === 'userspace' ? (
          <meta
            name="robots"
        ...
        <meta
          property="og:url"
          content={`https://justthetalk.co.uk${currentFolder.key}`}
        />
      </Head>
      <div className="container">
        ...
        {isCreatingDiscussion ? (
          <CreateDiscussion
            ...
            onCancelCreateDiscussion={onCancelCreateDiscussion}></CreateDiscussion>
        ) : (
          <></>
        )}
